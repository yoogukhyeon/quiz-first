...
export default function QuizeList({ quizList, id, number, onClickAnswer, onClickNext, userChk, over, stepNext, score }: QuizList) {
  const router = useRouter();

  const goToResult = () => {
    router.replace(`/result?score=${score}&id=${id}`);
  };
